  ...
  render() {
    return (
      <div className="officer">
        <div className={"officer__img-container officer__img-container--" + this.props.ordering}>
          <img src={squareUrl} alt="" />
        </div>
        <div className={"officer__body-container officer__body-container--" + this.props.ordering}>
          <div className="body">
