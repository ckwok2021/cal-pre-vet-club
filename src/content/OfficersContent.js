...
const officersContent = [
  {
    ...
    url: require("../images/officers/BrandonWeiss.jpg"),
    bio: (
      <div>
    ...
    url: require("../images/officers/DivyaRavichandran.jpg"),
    bio: (
      <div>
    ...
    url: require("../images/officers/JenniferGood.jpg"),
    bio: (
      <div>
    ...
    url: require("../images/officers/EvanChang.jpg"),
    bio: (
      <div>
    ...
    url: require("../images/officers/MauraMeijer.jpg"),
    bio: (
      <div>
    ...
    email: "calprevet.pr@gmail.com",
    url: require("../images/officers/JillianShaw.jpg"),
    bio: (
      <div>
    ...
    url: require("../images/officers/AnnieChen.jpg"),
    bio: (
      <div>
